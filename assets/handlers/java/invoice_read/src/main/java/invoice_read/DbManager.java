...
public class DbManager {
    ...
    static {
        try {
            ...
            System.out.println("Successfully connected to MongoDB for invoice_read.");

        } catch (Exception e) {
            System.err.println("FATAL: Failed to initialize MongoDB connection for invoice_read: " + e.getMessage());
            throw new RuntimeException("MongoDB initialization failed for invoice_read", e);
        }
    }

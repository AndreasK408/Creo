...
public class DbManager {
    ...
    static {
        try {
            ...
            if (port == null || port.trim().isEmpty()) port = "27017"; // Standard MongoDB Port
            ...
            System.out.println("Successfully connected to MongoDB for invoice_delete.");

        } catch (Exception e) {
            System.err.println("FATAL: Failed to initialize MongoDB connection for invoice_delete: " + e.getMessage());
            throw new RuntimeException("MongoDB initialization failed for invoice_delete", e);
        }
    }
